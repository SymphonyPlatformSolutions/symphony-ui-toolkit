...
<div style="margin: 16px;">
  ...
  <button class="tk-button tk-button--primary tk-button--icon-left"><i class="tk-icon-lock"></i>Icon left</button>
  <button class="tk-button tk-button--primary tk-button--icon-right">Icon right<i class="tk-icon-lock"></i></button>
...
<div style="margin: 16px;">
  ...
  <button class="tk-button tk-button--secondary tk-button--icon-left"><i class="tk-icon-lock"></i>Icon left</button>
  <button class="tk-button tk-button--secondary tk-button--icon-right">Icon right<i class="tk-icon-lock tk-button--icon-right"></i></button>
...
<div style="margin: 16px;">
  ...
  <button class="tk-button tk-button--tertiary tk-button--icon-left"><i class="tk-icon-lock"></i>Icon left</button>
  <button class="tk-button tk-button--tertiary tk-button--icon-right">Icon right<i class="tk-icon-lock"></i></button>
...
<div style="margin: 16px;">
  ...
  <button class="tk-button tk-button--primary tk-button--small tk-button--icon-left"><i class="tk-icon-lock"></i>Icon left</button>
  <button class="tk-button tk-button--primary tk-button--small tk-button--icon-right">Icon right<i class="tk-icon-lock"></i></button>
...
<div style="margin: 16px;">
  ...
  <button class="tk-button tk-button--secondary tk-button--small tk-button--icon-left"><i class="tk-icon-lock"></i>Icon left</button>
  <button class="tk-button tk-button--secondary tk-button--small tk-button--icon-right">Icon right<i class="tk-icon-lock"></i></button>
...
<div style="margin: 16px;">
  ...
  <button class="tk-button tk-button--tertiary tk-button--small tk-button--icon-left"><i class="tk-icon-lock"></i>Icon left</button>
  <button class="tk-button tk-button--tertiary tk-button--small tk-button--icon-right">Icon right<i class="tk-icon-lock"></i></button>
...
<div style="margin: 16px;">
  ...
  <button class="tk-button tk-button--primary tk-button--large tk-button--icon-right">Icon right<i class="tk-icon-lock"></i></button>
...
<div style="margin: 16px;">
  ...
  <button class="tk-button tk-button--secondary tk-button--large tk-button--icon-left"><i class="tk-icon-lock"></i>Icon left</button>
  <button class="tk-button tk-button--secondary tk-button--large tk-button--icon-right">Icon right<i class="tk-icon-lock"></i></button>
...
<div style="margin: 16px;">
  ...
  <button class="tk-button tk-button--tertiary tk-button--large tk-button--icon-left"><i class="tk-icon-lock"></i>Icon left</button>
  <button class="tk-button tk-button--tertiary tk-button--large tk-button--icon-right">Icon right<i class="tk-icon-lock"></i></button>
...
<div style="margin: 16px;">
  ...
  <button class="tk-button tk-button--primary--destructive tk-button--icon-left"><i class="tk-icon-lock"></i>Icon left</button>
  <button class="tk-button tk-button--primary--destructive tk-button--icon-right">Icon right<i class="tk-icon-lock"></i></button>
...
<div style="margin: 16px; margin-top:40px">
  ...
  <button class="tk-button tk-button--secondary">Button</button>
  <button class="tk-button tk-button--secondary tk-button--icon-left"><i class="tk-icon-lock"></i>Icon left</button>
  <button class="tk-button tk-button--secondary tk-button--icon-right">Icon right<i class="tk-icon-lock"></i></button>
  <button class="tk-button tk-button--secondary loading" disabled><i class="animate-spin tk-icon-loading"></i></button>
  <button class="tk-button tk-button--secondary tk-button--icon"><i class="tk-icon-video-off"></i></button>
  <button class="tk-button tk-button--secondary" disabled>Disabled</button>
  <button class="tk-button tk-button--secondary" disabled>Disabled <i class="tk-icon-lock"></i></button>
  ...
  <button class="tk-button tk-button--secondary--destructive tk-button--icon-left"><i class="tk-icon-lock"></i>Icon left</button>
  <button class="tk-button tk-button--secondary--destructive tk-button--icon-right">Icon right<i class="tk-icon-lock"></i></button>
...
<div style="margin: 16px; margin-top:40px">
  ...
  <button class="tk-button tk-button--tertiary--destructive tk-button--icon-left"><i class="tk-icon-lock"></i>Icon left</button>
  <button class="tk-button tk-button--tertiary--destructive tk-button--icon-right">Icon right<i class="tk-icon-lock"></i></button>
  ...
  <button class="tk-button tk-button--tertiary--accent tk-button--icon-left"><i class="tk-icon-lock"></i>Icon left</button>
  <button class="tk-button tk-button--tertiary--accent tk-button--icon-right">Icon right<i class="tk-icon-lock"></i></button>

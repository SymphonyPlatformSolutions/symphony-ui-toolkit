...
const meta: Meta<typeof CropContent> = {
  component: CropContent,
  title: 'Components/Containers/Crop Content',
} satisfies Meta<typeof CropContent>;
      
export default meta;
type Story = StoryObj<typeof CropContent>

export const Default: Story = {
  args: {
    className: 'tk-quote-container',
  },
  render: (args) => <CropContent {...args}>
    {sampleText}
    <div
      className="tk-m-2h"
...
export const WithoutContentOverflow: Story = {
  render: () => {
  ...
  render: () => {
    ...
    return (
      <div style={{ width: '80%' }}>
        ...
        <p><Icon className={'tk-mr-h tk-text-color--primary'} iconName="alert-triangle"/> When using the prop <b>collapsed</b>, the collapsed logic will not rely on the internal state anymore. Thus to keep <b>collapsed</b> up-to-date from an internal change, you need to listen to the event <b>onToggle</b>.</p>
      </div>
    );
  }
};

...
export const BorderedAvatar: Story = {
  render: () => {
    return (
      <div>
...
export const AvatarWithTopBadge: Story = {
  render: () => {
    return (
      <div>
...
export const AvatarWithBottomBadge: Story = {
  render: () => {
    return (
      <div>
...
export const AvatarWithAdvancedBadge: Story = {
  render: () => {
    return (
      <div>

...
import { customRenderOptions, IconPicker, MultiValueRemove } from '../../../src/components/dropdown/CustomRender';
...
describe('Dropdown component test suite =>', () => {
	...
	describe('when is simple Dropdown', () => {
		...
		it('should show/hide options menu', async () => {
			const { container, getByText } = render(<Dropdown options={dropdownProps.options} />);
